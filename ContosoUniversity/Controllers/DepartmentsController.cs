                ...
                s => s.Name, s => s.StartDate, s => s.Budget, s => s.InstructorID))
            {
                ...
                catch (DbUpdateConcurrencyException ex)
                {
                    ...
                    else
                    {
                        ...
                        {
                            ModelState.AddModelError("StartDatte", $"Current value: {databaseValues.StartDate:d}");
                        }
                        ...
                        ModelState.AddModelError(string.Empty, "The record you attempted to edit" + "was modified by another user after you go the original value. The" +
        ...
        public async Task<IActionResult> Delete(int? id, bool? concurrencyError)
        {
            ...
            if (concurrencyError.GetValueOrDefault())
            {
                ViewData["ConcurrencyErrorMessage"] = "The record you attempted to delete "
                    + "was modified by another user after you to the original values. "
